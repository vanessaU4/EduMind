...
export const useRoleBasedNavigation = () => {
  ...
  const allNavigationItems: NavigationItem[] = [
    ...
    // Community Features
    {
      ...
      children: [
        ...
        },
        {
          ...
          icon: Heart,
          requiredCapabilities: ['request_peer_support']
        },
        {
          name: 'Moderation',
    ...
    // Crisis Support
    {
      ...
      requiredCapabilities: ['access_crisis_hotlines', 'view_crisis_resources'],
      children: [
        {
          name: 'Crisis Hotlines',
          href: '/crisis/hotlines',
          icon: LifeBuoy,
          requiredCapabilities: ['access_crisis_hotlines']
        },
        {
          name: 'Safety Planning',
          href: '/crisis/safety-plan',
          icon: Shield,
          requiredCapabilities: ['create_safety_plan']
        },
        {
          name: 'Crisis Alerts',
          href: '/crisis/alerts',
          icon: AlertTriangle,
          requiredCapabilities: ['view_crisis_alerts', 'respond_to_crisis'],
          badge: getCrisisAlertCount(user)
        },
        {
          name: 'Grounding Techniques',
          href: '/crisis/grounding',
          icon: Target,
          requiredCapabilities: ['access_grounding_techniques']
        }
      ]
    },

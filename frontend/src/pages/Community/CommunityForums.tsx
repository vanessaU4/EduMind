            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <SelectTrigger className={`w-full ${!newPost.category ? 'border-red-300' : ''}`}>
                      ...
                      {categories.length === 0 ? (
                        ...
                        <>
                          ...
                          {categories
                            ...
                            .slice(0, 3)
                            .map(cat => (
                              <SelectItem key={`popular-${cat.id}`} value={cat.id}>
                          ...
                          {/* Separator if we have popular categories */}
                          {categories.some(cat => cat.postCount > 0) && (
                  ...
                  {!newPost.category && (
                    <p className="text-sm text-red-500 mt-1">Please select a category for your post</p>
                  )}
                </div>
                <div>
        ...
        {filteredPosts.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              {searchTerm ? 'Try adjusting your search terms or browse different categories.' : 'Be the first to start a meaningful discussion in our community!'}
            </p>
            <Button 
